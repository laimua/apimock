        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
            ...
            <button
              ...
              className={`flex-1 px-4 py-2.5 text-white rounded-lg transition-colors font-medium focus:ring-2 focus:ring-offset-2 text-sm min-h-11 disabled:opacity-50 disabled:cursor-not-allowed ${styles.confirmClass}`}
            >
              {confirmText}
            </button>
          </div>
